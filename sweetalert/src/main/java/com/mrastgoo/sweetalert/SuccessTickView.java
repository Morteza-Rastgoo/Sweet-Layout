...
public class SuccessTickView extends View {
    ...
    private float CONST_RADIUS = dip2px(10f);
    ...
    public void setRadius(float CONST_RADIUS) {
        this.CONST_RADIUS = dip2px(CONST_RADIUS);
        init();
        invalidate();
    }

    public void setRectWeight(float CONST_RECT_WEIGHT) {
        this.CONST_RECT_WEIGHT = dip2px(CONST_RECT_WEIGHT);
        init();
        invalidate();
    }

    public void setLeftRectWidth(float CONST_LEFT_RECT_W) {
        this.CONST_LEFT_RECT_W = dip2px(CONST_LEFT_RECT_W);
        init();
        invalidate();
    }

    public void setRightRectWidth(float CONST_RIGHT_RECT_W) {
        this.CONST_RIGHT_RECT_W = dip2px(CONST_RIGHT_RECT_W);
        init();
        invalidate();
    }

    public void setMinLeftRectWidth(float MIN_LEFT_RECT_W) {
        this.MIN_LEFT_RECT_W = dip2px(MIN_LEFT_RECT_W);
        init();
        invalidate();
    }

    public void setMinRightRectWidth(float MAX_RIGHT_RECT_W) {
        this.MAX_RIGHT_RECT_W = dip2px(MAX_RIGHT_RECT_W);
        init();
        invalidate();
    }
}