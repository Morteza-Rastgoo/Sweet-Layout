...
public class SweetAlertLayout extends RelativeLayout implements View.OnClickListener {
    private static final String TAG = "SweetAlert";
    ...
    public SweetAlertLayout(Context context) {
        super(context);
        mContext = context;
    }

    public SweetAlertLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(context);
    ...
    private void init(Context context) {
        ...
        mDialogView = /*getWindow().getDecorView().findViewById(android.R.id.content);*/ this;
    ...
    public SweetAlertLayout setTitleText(String text) {
        mTitleText = text;
    ...
    public SweetAlertLayout setCustomImage(Drawable drawable) {
    ...
    public SweetAlertLayout setCustomImage(int resourceId) {
    ...
    public SweetAlertLayout setContentText(String text) {
        mContentText = text;
    ...
    public SweetAlertLayout showCancelButton(boolean isShow) {
        mShowCancel = isShow;
    ...
    public SweetAlertLayout showContentText(boolean isShow) {
        mShowContent = isShow;
    ...
    public SweetAlertLayout setCancelText(String text) {
        mCancelText = text;
    ...
    public SweetAlertLayout setConfirmText(String text) {
        mConfirmText = text;
    ...
    public SweetAlertLayout setCancelClickListener(OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public SweetAlertLayout setConfirmClickListener(OnSweetClickListener listener) {
